...
<img width="300" height="300" alt="image" src="https://github.com/user-attachments/assets/15034fbb-7fcd-4138-933c-f7ed9388c736" />
...
특히 2026년 월드컵은 사상 최초로 48개국이 본선에 참가하게 되며, 경기 방식이 크게 변화할 것이다. 이에 따라 기존의 단순 전문가 분석이나 통계적 예측을 넘어, 머신러닝 기반의 정교한 성과 예측에 대한 수요가 커질 것으로 예상된다.
...
![Git](https://img.shields.io/badge/Git-F05032?style=flat&logo=git&logoColor=white) ![Latest](https://img.shields.io/badge/2.x-F05032?style=flat)  
![VSCode](https://img.shields.io/badge/VSCode-007ACC?style=flat&logo=visualstudiocode&logoColor=white) ![1.84.0](https://img.shields.io/badge/1.84.0-007ACC?style=flat)  
![Notion](https://img.shields.io/badge/Notion-000000?style=flat&logo=notion&logoColor=white) ![Workspace](https://img.shields.io/badge/Workspace-000000?style=flat)  
...
4. [[월드컵 본선] 순위 데이터 2002~2022 - 크롤링](https://namu.wiki/w/2022%20FIFA%20%EC%9B%94%EB%93%9C%EC%BB%B5%20%EC%B9%B4%ED%83%80%EB%A5%B4#s-8)
    1. 특정 국가의 해당년도 월드컵 순위
    2. 특정 국가의 해당년도 월드컵 승점
...
7. [[월드컵 본선] 선수 세부 스탯 데이터](https://www.kaggle.com/datasets/joebeachcapital/fifa-world-cups)
    1. 각 팀의 해당년도 월드컵 본선에서의 공격력 관련 수치
    2. 각 팀의 해당년도 월드컵 본선에서의 수비력 관련 수치

→ 총 7개의 팀 스탯탯 + 게임스탯(13) + 타겟 데이터 2개의 컬럼을 추출
...
| **Info** | **Describe** |
| --- | --- |
| <img width="300" height="600" alt="info image" src="https://github.com/user-attachments/assets/ba819aa2-fc39-451c-8d01-02b8ef710ba1" /> | <img width="600" height="300" alt="description image" src="https://github.com/user-attachments/assets/946498bd-43ec-40b0-8f9f-953b60593421" /> |
...
| **분류** | **분석 항목 / 지표** | **설명 / 목적** |
| --- | --- | --- |
| 예선전 & 친선전 승률과 골득실률 - 월드컵 본선 성적 | Q\_WR(예선 승률), Q\_GR(예선 골득실률), Wc\_Rank, Wc\_Point | 예선 성적이 본선 성과에 미치는 상관관계 분석 |
| 클럽 계수 Top 20 클럽에 속한 선수 수 - 본선 성적  | Avg\_Famous, Wc\_Rank, Wc\_Point | 유명 리그 선수 수가 월드컵 성과에 미치는 영향 분석  |
| 피파 랭킹/포인트 - 월드컵 성과 | F\_Rank, F\_Point, F\_Rd, F\_Pd | FIFA 랭킹과 포인트가 월드컵 순위 변동에 미치는 관계 분석 |
| 월드컵 경기 지표 - FIFA 게임 지표 | ATK\_INDEX, DEF\_INDEX, FS\_1\~FS\_13  | 경기 지표와 FIFA 게임 지표 간 상관관계 분석 |
| 월드컵 성적 - FIFA 게임 지표 | Wc\_Rank, FS\_1\~FS\_13 | 월드컵 성적과 FIFA 게임 지표 간 상관관계 분석 |
| 선수단 나이 - 공격/수비 지표 | Avg\_Age, Avg\_Apps, ATK\_INDEX, DEF\_INDEX | 선수단 평균 나이, 출장 수와 공격/수비 지표 비교 |
| 월드컵 경험 - 공격/수비 지표 | Avg\_Apps, ATK\_INDEX, DEF\_INDEX | 월드컵 순위와 경기 지표 간 상관관계 분석 |
| 우승팀 평균 나이 - 본선 진출 평균 횟수 | Avg\_Age, Avg\_Apps, 우승 여부 | 우승팀의 평균 나이와 본선 진출 횟수 간 관계 분석 |
| 세대 교체 경향 분석 | 특정 연도별(예: 2018→2022) 평균 나이, 신규/은퇴 선수 | 세대 교체 및 선수 구성 변화 분석 |


--- 

## 📄WBS
<img width="981" height="667" alt="image" src="https://github.com/user-attachments/assets/40f3bedf-edd1-4ad1-81eb-2ad115bfac36" />
